...
| 5 | `ClickShare` | 183 |
| 6 | `SMARTGATE_123456` | 144 |
| 7 | `ClickShare-Conference Room` | 130 |
| 8 | `Afsol Wifi` | 115 |
| 9 | `Smithway` | 66 |
| 10 | `MAX-PRINTER` | 65 |

*Computed from 76,605 SSID-bearing records (69,656 unique values) across all 19 OUI files in `data/by_oui/`. Stats update automatically after each scan.*
<!-- SSID_TOP10_END -->
...
<!-- SSID_PATTERNS_START -->
Filtering for only `Flock*`-prefixed SSIDs yields **143 unique variants** across **1,534 total records**. These fall into five distinct patterns:

| Pattern | Unique SSIDs | Records | Description |
|---------|-------------|---------|-------------|
| `Flock` | 1 | 1,392 | Bare name — fully configured / deployed cameras |
