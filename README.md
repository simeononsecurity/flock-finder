...
| 6 | `ClickShare-Boardroom` | 212 |
| 7 | `ClickShare` | 211 |
| 8 | `ClickShare-Conference Room` | 137 |
| 9 | `Audi HUD` | 130 |
| 10 | `Afsol Wifi` | 125 |

*Computed from 119,257 SSID-bearing records (108,666 unique values) across all 31 OUI files in `data/by_oui/`. Stats update automatically after each scan.*
<!-- SSID_TOP10_END -->
...
<!-- SSID_PATTERNS_START -->
Filtering for only `Flock*`-prefixed SSIDs yields **157 unique variants** across **2,791 total records**. These fall into five distinct patterns:

| Pattern | Unique SSIDs | Records | Description |
|---------|-------------|---------|-------------|
| `Flock` | 1 | 2,634 | Bare name — fully configured / deployed cameras |
