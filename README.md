...
|---|------|-------------|
| 1 | `Flock` | 2,222 |
| 2 | `SMARTGATE_123456` | 853 |
| 3 | `AndroidAP` | 328 |
| 4 | `TEST` | 291 |
| 5 | `Compudopt Connect` | 221 |
| 6 | `ClickShare` | 211 |
...
*Computed from 118,153 SSID-bearing records (108,022 unique values) across all 31 OUI files in `data/by_oui/`. Stats update automatically after each scan.*
<!-- SSID_TOP10_END -->
...
<!-- SSID_PATTERNS_START -->
Filtering for only `Flock*`-prefixed SSIDs yields **157 unique variants** across **2,379 total records**. These fall into five distinct patterns:

| Pattern | Unique SSIDs | Records | Description |
|---------|-------------|---------|-------------|
| `Flock` | 1 | 2,222 | Bare name — fully configured / deployed cameras |
