...
|---|------|-------------|
| 1 | `Flock` | 2,109 |
| 2 | `SMARTGATE_123456` | 845 |
| 3 | `AndroidAP` | 330 |
| 4 | `TEST` | 289 |
| 5 | `Compudopt Connect` | 224 |
| 6 | `ClickShare` | 210 |
| 7 | `ClickShare-Boardroom` | 210 |
| 8 | `ClickShare-Conference Room` | 137 |
| 9 | `Audi HUD` | 126 |
| 10 | `Afsol Wifi` | 122 |

*Computed from 117,828 SSID-bearing records (107,822 unique values) across all 31 OUI files in `data/by_oui/`. Stats update automatically after each scan.*
<!-- SSID_TOP10_END -->
...
<!-- SSID_PATTERNS_START -->
Filtering for only `Flock*`-prefixed SSIDs yields **157 unique variants** across **2,266 total records**. These fall into five distinct patterns:

| Pattern | Unique SSIDs | Records | Description |
|---------|-------------|---------|-------------|
| `Flock` | 1 | 2,109 | Bare name — fully configured / deployed cameras |
...
| Other | 2 | 3 | Other / non-standard patterns |
